...
export default function Index() {
  ...
  return (
      <Stack.Navigator  id={undefined} initialRouteName='TelaInicial' screenOptions={{headerShown:false}}>
        <Stack.Screen name='TelaInicial' component={TelaInicial} options={{headerShown:false}}/>
        <Stack.Screen name='AlterarInformacoesPerfil' component={AlterarInformacoesPerfil} options={{headerShown:false}}/>
        <Stack.Screen name='DetalhamentoReceita' component={DetalhamentoReceita} options={{headerShown:false}}/>
        <Stack.Screen name='DetalhamentoRestaurante' component={DetalhamentoRestaurante} options={{headerShown:false}}/>
        <Stack.Screen name='TelaCadastro' component={TelaCadastro} options={{headerShown:false}}/>
        <Stack.Screen name='TelaCadastroReceita' component={TelaCadastroReceita} options={{headerShown:false}}/>
        <Stack.Screen name='TelaCarregamento' component={TelaCarregamento} options={{headerShown:false}}/>
        <Stack.Screen name='TelaListagemRestaurantes' component={TelaListagemRestaurantes} options={{headerShown:false}}/>
        <Stack.Screen name='TelaListarProdutos' component={TelaListarProdutos} options={{headerShown:false}}/>
        <Stack.Screen name='TelaListarReceitas' component={TelaListarReceitas} options={{headerShown:false}}/>
        <Stack.Screen name='TelaLogin' component={TelaLogin} options={{headerShown:false}}/>
        <Stack.Screen name='TelaMeuPerfil' component={TelaMeuPerfil} options={{headerShown:false}}/>
        <Stack.Screen name='TelaRecuperacaoSenha' component={TelaRecuperacaoSenha} options={{headerShown:false}}/>
        <Stack.Screen name='TelaRedefinirSenha' component={TelaRedefinirSenha} options={{headerShown:false}}/>
      </Stack.Navigator>
  );
}
